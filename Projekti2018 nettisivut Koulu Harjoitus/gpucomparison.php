...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="etusivu.php">Home</a></li>
      ...
      <li class="active"><a href="gpucomparison.php">Compare GPU's</a></li>
      <li class="dropdown">
    ...
    <ul class="nav navbar-nav navbar-right">
      <?php julkinenTest();?>
        ...
        <?php
              ...
              $sql = "SELECT TeknisetGPU.GPU_ID AS ID, Valmistaja.ValmistajaNimi AS Valmistaja, Merkki.MerkkiNimi AS Merkki, Sarja.SarjaNimi AS Sarja, Malli.MalliNimi AS Malli
              FROM TeknisetGPU
...
<div class="container">
<form action="GPUvertailu.php" method="get">
      <div class="col-sm-6">
      <div class="form-group">
            <select class='form-control' name='GPU1' placeholder='Search CPU1'>
      ...
      <div class="col-sm-6">
      <div class="form-group">
            <select class='form-control' name='GPU2' placeholder='Search CPU1'>
            <?php foreach ($tulos as $row){ ?>
              <option value="<?php echo $row['ID'];?>"> <?php echo $row['Valmistaja'];?> <?php echo $row['Merkki'];?> <?php echo $row['Sarja'];?> <?php echo $row['Malli'];?></option>
                <?php } ?>
            </select>
      </div>
      </div>
