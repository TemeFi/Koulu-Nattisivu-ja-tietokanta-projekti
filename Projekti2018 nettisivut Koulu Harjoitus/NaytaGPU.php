...
<head>
  ...
  <title>Vertailutyökalu - GPU</title>
  <meta charset="utf-8">
...
$sqlLause = "SELECT ValmistajaNimi, MerkkiNimi, SarjaNimi, MalliNimi, CUDA_STREAM, GDDR, GPUKellotaajuusBASE, GPUKellotaajuusBOOST, GPUMEMKapasiteetti, GPUMEMKellotaajuus, Korkeus, Leveys, MaxPystyReso, MaxVaakaReso, Pituus 
...
$GPUKellotaajuusBASE = $GPUKellotaajuusBASE/1000;
$GPUKellotaajuusBOOST = $GPUKellotaajuusBOOST/1000;
$GPUMEMKellotaajuus = $GPUMEMKellotaajuus/1000;

echo "<div class='container'>";
echo  "<h2>{$ValmistajaNimi} {$MerkkiNimi} {$SarjaNimi} {$MalliNimi}</h2>";        
...
echo      "<tr>";
echo        "<td>Malli</td>";
echo        "<td>{$MalliNimi}</td>";
echo      "</tr>";
echo      "<tr>";
echo        "<td>CUDA/Stream ytimet</td>";
echo        "<td>{$CUDA_STREAM}</td>";
echo      "</tr>";
echo      "<tr>";
echo        "<td>Muistintyyppi</td>";
echo        "<td>GDDR{$GDDR}</td>";
echo      "</tr>";
echo      "<tr>";
echo        "<td>Kellotaajuus</td>";
echo        "<td>{$GPUKellotaajuusBASE} GHz</td>";
echo      "</tr>";
echo      "<tr>";
echo        "<td>Maksimi kellotaajuus</td>";
echo        "<td>{$GPUKellotaajuusBOOST} GHz</td>";
echo      "</tr>";
echo        "<td>Muistikapasiteetti</td>";
echo        "<td>{$GPUMEMKapasiteetti} GB</td>";
echo      "</tr>";
echo      "</tr>";
echo        "<td>Muistin kellotaajus</td>";
echo        "<td>{$GPUMEMKellotaajuus} GHz</td>";
echo      "</tr>";
echo      "</tr>";
echo        "<td>Korkeus</td>";
echo        "<td>{$Korkeus} mm</td>";
echo      "</tr>";
echo      "</tr>";
echo        "<td>Leveys</td>";
echo        "<td>{$Leveys} mm</td>";
echo      "</tr>";
echo      "</tr>";
echo        "<td>Pituus</td>";
echo        "<td>{$Pituus} mm</td>";
echo      "</tr>";
echo      "</tr>";
echo        "<td>Pystyresoluutio</td>";
echo        "<td>{$MaxPystyReso} px</td>";
echo      "</tr>";
echo      "</tr>";
echo        "<td>Vaakaresoluutio</td>";
echo        "<td>{$MaxVaakaReso} px</td>";
echo      "</tr>";
echo    "</tbody>";
echo  "</table>";
echo "</div>";
...
FROM GPUVerkkokauppalinkit
WHERE VerkkokauppaID = 600 AND GPUTuoteID = $key;";
...
FROM GPUVerkkokauppalinkit
WHERE VerkkokauppaID = 601 AND GPUTuoteID = $key;";
...
for ($i = 0; $i < $metas->length; $i++)
{
 ...
 FROM GPUVerkkokauppalinkit
 WHERE VerkkokauppaID = 605 AND GPUTuoteID = $key;";
...
<div class="card text-center">
  <div class="card-body">
    ...
    <h3 class="card-text">Votes : <?php echo $GPURating; ?></h3>
...
if ($response != null && $response->success) {
  ...
  $lisaysKomento = "UPDATE TeknisetGPU  

  SET GPURating = GPURating + 1  
