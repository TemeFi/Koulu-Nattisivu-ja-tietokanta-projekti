<html lang="en">
<head>
  <title>Vertailutyökalu - GPU list</title>
  <meta charset="utf-8">
...
<div class="container">
  ...
  $sqlLause = "SELECT TeknisetGPU.GPU_ID, Valmistaja.ValmistajaNimi, Merkki.MerkkiNimi, Sarja.SarjaNimi, Malli.MalliNimi
  FROM TeknisetGPU
  ...
  // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
    ...
    echo "<td>";
        echo "<a href='NaytaGPU.php?ID=$GPU_ID' class='btn btn-info m-r-1em'>Show all specs</a>";
    echo "</td>";
  echo "</tr>";
  }
  echo "</table>"; 
