...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="newValmistaja.php">Valmistaja</a></li>
      ...
      <li class="active"><a href="newLiitin.php">Liitin</a></li>
...
// lomakkeelta lähetetään tietoa, tapahtuu tämä php-koodi
    ...
    try{
      ...
      $lisaysKomento = "INSERT INTO Liittimet SET Liitin = :tyyppi ";
...
<div class="container-fluid">
  ...
  <?php
    ...
    $sqlLause = "SELECT LiitinID, Liitin FROM Liittimet ";
    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
      ...
      // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
          ...
          echo "<td>{$Liitin}</td>";
          echo "<td>";
              echo "<a href='Yllapito.php?ID={$LiitinID}&IDN=LiitinID&Nimi=Liitin&Taulu=Liittimet&Return=Liitin' class='btn btn-primary m-r-1em'>Ylläpidä osastotietoja</a> &nbsp";
              echo "<a  href='deleteTiedosto.php?poistTaulu=Liittimet&poistID={$LiitinID}&poistIDN=LiitinID&Return=newLiitin' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$LiitinID - $Liitin'>Poista osasto</a>";
          echo "</td>";
      echo "</tr>";
  }
  }
