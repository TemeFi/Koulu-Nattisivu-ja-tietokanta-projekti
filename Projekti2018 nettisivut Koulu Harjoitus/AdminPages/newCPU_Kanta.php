...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="newValmistaja.php">Valmistaja</a></li>
      ...
      <li class="active"><a href="newCPU_Kanta.php">CPU kanta</a></li>
...
// lomakkeelta lähetetään tietoa, tapahtuu tämä php-koodi
    ...
    try{
      ...
      $lisaysKomento = "INSERT INTO CPU_Kanta SET Kanta = :tyyppi ";
...
<div class="container-fluid">
  ...
  <?php
    ...
    $sqlLause = "SELECT KantaID, Kanta FROM CPU_Kanta ";
    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
      ...
      // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
          ...
          echo "<td>{$Kanta}</td>";
          echo "<td>";
              echo "<a href='Yllapito.php?ID={$KantaID}&IDN=KantaID&Nimi=Kanta&Taulu=CPU_Kanta&Return=CPU_Kanta' class='btn btn-primary m-r-1em'>Ylläpidä osastotietoja</a> &nbsp";
              echo "<a  href='deleteTiedosto.php?poistTaulu=CPU_Kanta&poistID={$KantaID}&poistIDN=KantaID&Return=newCPU_Kanta' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$KantaID - $Kanta'>Poista osasto</a>";
          echo "</td>";
      echo "</tr>";
  }
  }
