...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="newValmistaja.php">Valmistaja</a></li>
      ...
      <li class="active"><a href="newVirtaliitin.php">Virtaliitin</a></li>
...
// lomakkeelta lähetetään tietoa, tapahtuu tämä php-koodi
    ...
    try{
      ...
      $lisaysKomento = "INSERT INTO Virtaliitin SET Virtaliitintyyppi = :tyyppi ";
...
<div class="container-fluid">
    ...
    $sqlLause = "SELECT VirtaliitinID, Virtaliitintyyppi FROM Virtaliitin ";
    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
        ...
        // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
            echo "<tr>";
            echo "<td>{$VirtaliitinID}</td>";
            echo "<td>{$Virtaliitintyyppi}</td>";
            echo "<td>";
                echo "<a href='Yllapito.php?ID={$VirtaliitinID}&IDN=VirtaliitinID&Nimi=Virtaliitintyyppi&Taulu=Virtaliitin&Return=Virtaliitin' class='btn btn-primary m-r-1em'>Ylläpidä osastotietoja</a> &nbsp";
                echo "<a  href='deleteTiedosto.php?poistTaulu=Virtaliitin&poistID={$VirtaliitinID}&poistIDN=VirtaliitinID&Return=newVirtaliitin' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$VirtaliitinID - $Virtaliitintyyppi'>Poista osasto</a>";
            echo "</td>";
        echo "</tr>";
    }
    }
