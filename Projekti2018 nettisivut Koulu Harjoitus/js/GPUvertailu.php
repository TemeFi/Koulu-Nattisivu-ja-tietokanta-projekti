...
echo        "<td>{$GPUKellotaajuusBASE1}</td>";
echo        "<td>{$GPUKellotaajuusBASE2}</td>";
echo      "</tr>";
echo        "<td><b>Maksimi kellotaajuus</b></td>";
echo        "<td>{$GPUKellotaajuusBOOST1}</td>";
echo        "<td>{$GPUKellotaajuusBOOST2}</td>";
echo      "</tr>";
echo      "</tr>";
...
echo        "<td>{$GPUMEMKellotaajuus1}</td>";
echo        "<td>{$GPUMEMKellotaajuus2}</td>";
echo      "</tr>";
echo      "</tr>";
