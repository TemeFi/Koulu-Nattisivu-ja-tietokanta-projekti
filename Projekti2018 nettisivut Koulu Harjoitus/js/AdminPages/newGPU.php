    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
      ...
      // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
          ...
          echo "<td>";
              ...
              echo "<a  href='DeleteComponent.php?poistoLinkkiTID=GPUTuoteID&poistTaulu=TeknisetGPU&Taulu=GPUVerkkokauppalinkit&poistID={$GPU_ID}&poistIDN=GPU_ID&Return=newGPU' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$GPU_ID - $MerkkiNimi $ValmistajaNimi $SarjaNimi $MalliNimi'>Poista osasto</a>  &nbsp";
              echo "<a  href='LisaaKauppa.php?ID={$GPU_ID}&IDN=GPU_ID&Taulu=TeknisetGPU&Is=GPU&Return=newGPU' class='btn btn-warning'>Linkkien Hallinta</a>";
