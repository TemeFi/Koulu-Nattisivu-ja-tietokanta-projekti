...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="newValmistaja.php">Valmistaja</a></li>
      ...
      <li class="active"><a href="newMalli.php">Malli</a></li>
...
// lomakkeelta lähetetään tietoa, tapahtuu tämä php-koodi
    ...
    try{
      ...
      $lisaysKomento = "INSERT INTO Malli SET MalliNimi = :tyyppi ";
...
<div class="container-fluid">
    ...
    $sqlLause = "SELECT MalliID, MalliNimi FROM Malli ";
    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
        ...
        // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
            ...
            echo "<td>";
                echo "<a href='Yllapito.php?ID={$MalliID}&IDN=MalliID&Nimi=MalliNimi&Taulu=Malli&Return=Malli' class='btn btn-primary m-r-1em'>Ylläpidä osastotietoja</a> &nbsp";
                echo "<a  href='deleteTiedosto.php?poistTaulu=Malli&poistID={$MalliID}&poistIDN=MalliID&Return=newMalli' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$MalliID - $MalliNimi'>Poista osasto</a>";
            echo "</td>";
        echo "</tr>";
    }
    }
