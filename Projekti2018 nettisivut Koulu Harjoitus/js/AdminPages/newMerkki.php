...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="newMerkki.php">Merkki</a></li>
...
// lomakkeelta lähetetään tietoa, tapahtuu tämä php-koodi
    ...
    try{
      ...
      $lisaysKomento = "INSERT INTO Merkki SET MerkkiNimi = :tyyppi ";
...
<div class="container-fluid">
    ...
    $sqlLause = "SELECT MerkkiID, MerkkiNimi FROM Merkki ";
    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
        ...
        // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
            ...
            echo "<td>";
                echo "<a href='Yllapito.php?ID={$MerkkiID}&IDN=MerkkiID&Nimi=MerkkiNimi&Taulu=Merkki&Return=Merkki' class='btn btn-primary m-r-1em'>Ylläpidä osastotietoja</a> &nbsp";
                echo "<a  href='deleteTiedosto.php?poistTaulu=Merkki&poistID={$MerkkiID}&poistIDN=MerkkiID&Return=newMerkki' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$MerkkiID - $MerkkiNimi'>Poista osasto</a>";
            echo "</td>";
        echo "</tr>";
    }
    }
