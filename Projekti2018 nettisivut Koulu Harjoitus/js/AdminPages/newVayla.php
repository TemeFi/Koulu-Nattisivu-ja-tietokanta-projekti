...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="newValmistaja.php">Valmistaja</a></li>
      ...
      <li class="active"><a href="newVayla.php">Väylä</a></li>
...
// lomakkeelta lähetetään tietoa, tapahtuu tämä php-koodi
    ...
    $lisaysKomento = "INSERT INTO Vaylat SET Vayla  =:tyyppi ";
...
<div class="container-fluid">
  ...
  <?php
    ...
    $sqlLause = "SELECT VaylaID, Vayla FROM Vaylat ";
    ...
    while ($rivi = $komento->fetch(PDO::FETCH_ASSOC)){
      ...
      // tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
          ...
          echo "<td>{$Vayla}</td>";
          echo "<td>";
              echo "<a href='Yllapito.php?ID={$VaylaID}&IDN=VaylaID&Nimi=Vayla&Taulu=Vaylat&Return=Vayla' class='btn btn-primary m-r-1em'>Ylläpidä osastotietoja</a> &nbsp";
              echo "<a  href='deleteTiedosto.php?poistTaulu=Vaylat&poistID={$VaylaID}&poistIDN=VaylaID&Return=newVayla' onclick='return checkDelete(this.id)' class='btn btn-danger' id='$VaylaID - $Vayla'>Poista osasto</a>";
          echo "</td>";
      echo "</tr>";
  }
  }
