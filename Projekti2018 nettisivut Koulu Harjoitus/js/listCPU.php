...
$sqlLause = "SELECT TeknisetCPU.CPU_ID, Merkki.MerkkiNimi, Sarja.SarjaNimi, TeknisetCPU.Malli
FROM TeknisetCPU
...
// tehdään jokaisesta osastotaulun rivistä oma rivi tauluun
  ...
  echo "<td>{$Malli}</td>";
  echo "<td>";
      echo "<a href='NaytaCPU.php?ID=$CPU_ID' class='btn btn-info m-r-1em'>Show all specs</a>";
  echo "</td>";
echo "</tr>";
}
echo "</table>"; 
